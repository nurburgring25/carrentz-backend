...
public class UserVehicleService {
    ...
    public Response vehicles(@QueryParam("storeId") long storeId) throws Exception {
        ...
        for (VehicleEntity vehicleEntity : vehicleEntities) {
            ...
            for (HashEntity hashEntity : hashEntities) {
                ...
                userVehicleImageItem.setUrl(Constant.Application.BASE_URL + "users/vehicles/images/" + userVehicleImageItem.getId());
    ...
    @GET
    @Path("/vehicle-by-types/{id}")
    @RolesAllowed("UserEntity")
    @Produces(MediaType.APPLICATION_JSON)
    public Response vehicleByTypes(@PathParam("id") long id) throws Exception {
        UserVehicleListResponse userVehicleListResponse = new UserVehicleListResponse();
