 ...
 */
public class NoSuchMarkEncryptedColumnException extends RuntimeException {
    private final Class<? extends Entity> mEntityClass;
    private final Field mField;

    public NoSuchMarkEncryptedColumnException(
    ...
    public String getMessage() {
        return this.mField.getName() + " field in " + this.mEntityClass.getSimpleName() + " class, is not annotated with @MarkEncryptedColumn.";
    }
}